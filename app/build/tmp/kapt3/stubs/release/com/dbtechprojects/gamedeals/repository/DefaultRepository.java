...
public final class DefaultRepository {
    ...
    public final kotlinx.coroutines.flow.Flow<com.dbtechprojects.gamedeals.data.Resource<java.util.List<com.dbtechprojects.gamedeals.models.Game>>> search(@org.jetbrains.annotations.NotNull()
    java.lang.String Title) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.Flow<com.dbtechprojects.gamedeals.data.Resource<java.util.List<com.dbtechprojects.gamedeals.models.GameStore>>> storeSearch(@org.jetbrains.annotations.NotNull()
    java.lang.String storeid) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.Flow<java.util.List<com.dbtechprojects.gamedeals.models.Game>> getSavedDeals() {
        return null;
    }
    
    @org.jetbrains.annotations.Nullable()
    public final java.lang.Object saveGameDeal(@org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.Nullable()
    public final java.lang.Object deleteSearchCache(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> p0) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.Flow<java.util.List<com.dbtechprojects.gamedeals.models.Game>> getGamesFromDB(@org.jetbrains.annotations.NotNull()
    java.lang.String title) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.Flow<java.util.List<com.dbtechprojects.gamedeals.models.GameStore>> getLastThirtyStoreDeals() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final kotlinx.coroutines.flow.Flow<java.lang.String> getSearchTerm() {
        return null;
    }
