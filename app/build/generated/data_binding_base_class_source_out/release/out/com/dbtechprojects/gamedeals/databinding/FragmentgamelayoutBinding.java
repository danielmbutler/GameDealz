...
public final class FragmentgamelayoutBinding implements ViewBinding {
  ...
  private FragmentgamelayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentgamelayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentgamelayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragmentgamelayout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentgamelayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentgamelayoutBinding((ConstraintLayout) rootView, GameFragementSearchButton,
