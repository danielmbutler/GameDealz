...
public abstract class Hilt_GameFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GameFragment_GeneratedInjector) this.generatedComponent()).injectGameFragment(UnsafeCasts.<GameFragment>unsafeCast(this));
    }
  }
