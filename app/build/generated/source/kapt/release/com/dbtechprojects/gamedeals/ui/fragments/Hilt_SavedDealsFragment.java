...
public abstract class Hilt_SavedDealsFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SavedDealsFragment_GeneratedInjector) this.generatedComponent()).injectSavedDealsFragment(UnsafeCasts.<SavedDealsFragment>unsafeCast(this));
    }
  }
