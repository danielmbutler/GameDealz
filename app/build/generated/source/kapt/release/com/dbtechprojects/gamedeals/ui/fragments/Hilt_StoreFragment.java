...
public abstract class Hilt_StoreFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StoreFragment_GeneratedInjector) this.generatedComponent()).injectStoreFragment(UnsafeCasts.<StoreFragment>unsafeCast(this));
    }
  }
