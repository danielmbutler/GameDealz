...
public final class DaggerGameFragmentTest_HiltComponents_SingletonC extends GameFragmentTest_HiltComponents.SingletonC {
  ...
  private DaggerGameFragmentTest_HiltComponents_SingletonC(
  ...
  @Override
  public void injectTest(GameFragmentTest gameFragmentTest) {
  }
  ...
  public static final class Builder {
    ...
    public GameFragmentTest_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new DaggerGameFragmentTest_HiltComponents_SingletonC(applicationContextModule);
    }
  }

  private final class ActivityRetainedCBuilder implements GameFragmentTest_HiltComponents.ActivityRetainedC.Builder {
    @Override
    public GameFragmentTest_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl();
    }
  }

  private final class ActivityRetainedCImpl extends GameFragmentTest_HiltComponents.ActivityRetainedC {
    ...
    private final class ActivityCBuilder implements GameFragmentTest_HiltComponents.ActivityC.Builder {
      ...
      @Override
      public GameFragmentTest_HiltComponents.ActivityC build() {
        Preconditions.checkBuilderRequirement(activity, Activity.class);
        return new ActivityCImpl(activity);
      }
    }

    private final class ActivityCImpl extends GameFragmentTest_HiltComponents.ActivityC {
      ...
      private GameDealViewModel_AssistedFactory gameDealViewModel_AssistedFactory() {
        return GameDealViewModel_AssistedFactory_Factory.newInstance(DaggerGameFragmentTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private GameStoreViewModel_AssistedFactory gameStoreViewModel_AssistedFactory() {
        return GameStoreViewModel_AssistedFactory_Factory.newInstance(DaggerGameFragmentTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private MainViewModel_AssistedFactory mainViewModel_AssistedFactory() {
        return MainViewModel_AssistedFactory_Factory.newInstance(DaggerGameFragmentTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private SavedDealViewModel_AssistedFactory savedDealViewModel_AssistedFactory() {
        return SavedDealViewModel_AssistedFactory_Factory.newInstance(DaggerGameFragmentTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private SettingsViewModel_AssistedFactory settingsViewModel_AssistedFactory() {
        return SettingsViewModel_AssistedFactory_Factory.newInstance(DaggerGameFragmentTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private ViewModelProvider.Factory provideFactory() {
        return ViewModelFactoryModules_ActivityModule_ProvideFactoryFactory.provideFactory(activity, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerGameFragmentTest_HiltComponents_SingletonC.this.applicationContextModule), mapOfStringAndProviderOfViewModelAssistedFactoryOf());
      }
      ...
      public DefaultViewModelFactories.InternalFactoryFactory getHiltInternalFactoryFactory() {
        return DefaultViewModelFactories_InternalFactoryFactory_Factory.newInstance(ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerGameFragmentTest_HiltComponents_SingletonC.this.applicationContextModule), ImmutableSet.<String>of(), new ViewModelCBuilder(), defaultActivityViewModelFactorySetOfViewModelProviderFactory(), ImmutableSet.<ViewModelProvider.Factory>of());
      }
      ...
      private final class FragmentCBuilder implements GameFragmentTest_HiltComponents.FragmentC.Builder {
        ...
        @Override
        public GameFragmentTest_HiltComponents.FragmentC build() {
          Preconditions.checkBuilderRequirement(fragment, Fragment.class);
          return new FragmentCImpl(fragment);
        }
      }

      private final class FragmentCImpl extends GameFragmentTest_HiltComponents.FragmentC {
        ...
        private ViewModelProvider.Factory provideFactory() {
          return ViewModelFactoryModules_FragmentModule_ProvideFactoryFactory.provideFactory(fragment, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerGameFragmentTest_HiltComponents_SingletonC.this.applicationContextModule), ActivityCImpl.this.mapOfStringAndProviderOfViewModelAssistedFactoryOf());
        }
        ...
        private final class ViewWithFragmentCBuilder implements GameFragmentTest_HiltComponents.ViewWithFragmentC.Builder {
          private View view;
          ...
          @Override
          public GameFragmentTest_HiltComponents.ViewWithFragmentC build() {
            Preconditions.checkBuilderRequirement(view, View.class);
            return new ViewWithFragmentCImpl(view);
          }
        }

        private final class ViewWithFragmentCImpl extends GameFragmentTest_HiltComponents.ViewWithFragmentC {
      ...
      private final class ViewCBuilder implements GameFragmentTest_HiltComponents.ViewC.Builder {
        private View view;
        ...
        @Override
        public GameFragmentTest_HiltComponents.ViewC build() {
          Preconditions.checkBuilderRequirement(view, View.class);
          return new ViewCImpl(view);
        }
      }

      private final class ViewCImpl extends GameFragmentTest_HiltComponents.ViewC {
    ...
    private final class ViewModelCBuilder implements GameFragmentTest_HiltComponents.ViewModelC.Builder {
      ...
      @Override
      public GameFragmentTest_HiltComponents.ViewModelC build() {
        Preconditions.checkBuilderRequirement(savedStateHandle, SavedStateHandle.class);
        return new ViewModelCImpl(savedStateHandle);
      }
    }

    private final class ViewModelCImpl extends GameFragmentTest_HiltComponents.ViewModelC {
  ...
  private final class ServiceCBuilder implements GameFragmentTest_HiltComponents.ServiceC.Builder {
    ...
    @Override
    public GameFragmentTest_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(service);
    }
  }

  private final class ServiceCImpl extends GameFragmentTest_HiltComponents.ServiceC {
  ...
  private final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        ...
        return (T) DaggerGameFragmentTest_HiltComponents_SingletonC.this.mainRepository();
