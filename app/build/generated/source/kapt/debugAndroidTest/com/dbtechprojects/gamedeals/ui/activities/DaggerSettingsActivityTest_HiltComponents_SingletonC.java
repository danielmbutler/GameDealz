...
public final class DaggerSettingsActivityTest_HiltComponents_SingletonC extends SettingsActivityTest_HiltComponents.SingletonC {
  ...
  private DaggerSettingsActivityTest_HiltComponents_SingletonC(
  ...
  @Override
  public void injectTest(SettingsActivityTest settingsActivityTest) {
  }
  ...
  public static final class Builder {
    ...
    public SettingsActivityTest_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new DaggerSettingsActivityTest_HiltComponents_SingletonC(applicationContextModule);
    }
  }

  private final class ActivityRetainedCBuilder implements SettingsActivityTest_HiltComponents.ActivityRetainedC.Builder {
    @Override
    public SettingsActivityTest_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl();
    }
  }

  private final class ActivityRetainedCImpl extends SettingsActivityTest_HiltComponents.ActivityRetainedC {
    ...
    private final class ActivityCBuilder implements SettingsActivityTest_HiltComponents.ActivityC.Builder {
      ...
      @Override
      public SettingsActivityTest_HiltComponents.ActivityC build() {
        Preconditions.checkBuilderRequirement(activity, Activity.class);
        return new ActivityCImpl(activity);
      }
    }

    private final class ActivityCImpl extends SettingsActivityTest_HiltComponents.ActivityC {
      ...
      private GameDealViewModel_AssistedFactory gameDealViewModel_AssistedFactory() {
        return GameDealViewModel_AssistedFactory_Factory.newInstance(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private GameStoreViewModel_AssistedFactory gameStoreViewModel_AssistedFactory() {
        return GameStoreViewModel_AssistedFactory_Factory.newInstance(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private MainViewModel_AssistedFactory mainViewModel_AssistedFactory() {
        return MainViewModel_AssistedFactory_Factory.newInstance(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private SavedDealViewModel_AssistedFactory savedDealViewModel_AssistedFactory() {
        return SavedDealViewModel_AssistedFactory_Factory.newInstance(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private SettingsViewModel_AssistedFactory settingsViewModel_AssistedFactory() {
        return SettingsViewModel_AssistedFactory_Factory.newInstance(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.mainRepositoryProvider());
      }
      ...
      private ViewModelProvider.Factory provideFactory() {
        return ViewModelFactoryModules_ActivityModule_ProvideFactoryFactory.provideFactory(activity, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.applicationContextModule), mapOfStringAndProviderOfViewModelAssistedFactoryOf());
      }
      ...
      public DefaultViewModelFactories.InternalFactoryFactory getHiltInternalFactoryFactory() {
        return DefaultViewModelFactories_InternalFactoryFactory_Factory.newInstance(ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.applicationContextModule), ImmutableSet.<String>of(), new ViewModelCBuilder(), defaultActivityViewModelFactorySetOfViewModelProviderFactory(), ImmutableSet.<ViewModelProvider.Factory>of());
      }
      ...
      private final class FragmentCBuilder implements SettingsActivityTest_HiltComponents.FragmentC.Builder {
        ...
        @Override
        public SettingsActivityTest_HiltComponents.FragmentC build() {
          Preconditions.checkBuilderRequirement(fragment, Fragment.class);
          return new FragmentCImpl(fragment);
        }
      }

      private final class FragmentCImpl extends SettingsActivityTest_HiltComponents.FragmentC {
        ...
        private ViewModelProvider.Factory provideFactory() {
          return ViewModelFactoryModules_FragmentModule_ProvideFactoryFactory.provideFactory(fragment, ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.applicationContextModule), ActivityCImpl.this.mapOfStringAndProviderOfViewModelAssistedFactoryOf());
        }
        ...
        @Override
        public DefaultViewModelFactories.InternalFactoryFactory getHiltInternalFactoryFactory() {
          return DefaultViewModelFactories_InternalFactoryFactory_Factory.newInstance(ApplicationContextModule_ProvideApplicationFactory.provideApplication(DaggerSettingsActivityTest_HiltComponents_SingletonC.this.applicationContextModule), ImmutableSet.<String>of(), new ViewModelCBuilder(), ActivityCImpl.this.defaultActivityViewModelFactorySetOfViewModelProviderFactory(), defaultFragmentViewModelFactorySetOfViewModelProviderFactory());
        }
        ...
        private final class ViewWithFragmentCBuilder implements SettingsActivityTest_HiltComponents.ViewWithFragmentC.Builder {
          private View view;
          ...
          @Override
          public SettingsActivityTest_HiltComponents.ViewWithFragmentC build() {
            Preconditions.checkBuilderRequirement(view, View.class);
            return new ViewWithFragmentCImpl(view);
          }
        }

        private final class ViewWithFragmentCImpl extends SettingsActivityTest_HiltComponents.ViewWithFragmentC {
      ...
      private final class ViewCBuilder implements SettingsActivityTest_HiltComponents.ViewC.Builder {
        private View view;
        ...
        @Override
        public SettingsActivityTest_HiltComponents.ViewC build() {
          Preconditions.checkBuilderRequirement(view, View.class);
          return new ViewCImpl(view);
        }
      }

      private final class ViewCImpl extends SettingsActivityTest_HiltComponents.ViewC {
    ...
    private final class ViewModelCBuilder implements SettingsActivityTest_HiltComponents.ViewModelC.Builder {
      ...
      @Override
      public SettingsActivityTest_HiltComponents.ViewModelC build() {
        Preconditions.checkBuilderRequirement(savedStateHandle, SavedStateHandle.class);
        return new ViewModelCImpl(savedStateHandle);
      }
    }

    private final class ViewModelCImpl extends SettingsActivityTest_HiltComponents.ViewModelC {
  ...
  private final class ServiceCBuilder implements SettingsActivityTest_HiltComponents.ServiceC.Builder {
    ...
    @Override
    public SettingsActivityTest_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(service);
    }
  }

  private final class ServiceCImpl extends SettingsActivityTest_HiltComponents.ServiceC {
  ...
  private final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        ...
        return (T) DaggerSettingsActivityTest_HiltComponents_SingletonC.this.mainRepository();
